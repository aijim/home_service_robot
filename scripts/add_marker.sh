...
xterm -e " export ROBOT_INITIAL_POSE='-x 0 -y -3 -Y 0';  roslaunch turtlebot_gazebo turtlebot_world.launch world_file:=$(rospack find add_markers)/../worlds/my_room.world"&
sleep 5
